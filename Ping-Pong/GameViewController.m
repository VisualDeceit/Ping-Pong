...
//  Ping-Pong
//
//  Created by Alexander Fomin on 14.06.2021.
//
...
- (void)createPuddles {
    ...
    _paddleTop.image = [UIImage imageNamed:@"paddle"];
    ...
    _paddleBottom.image = [UIImage imageNamed:@"paddle2"];
...
- (void)newGame {
    ...
    [self displayMessage:@"Ready to rumble?"];
}
